    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="container mx-auto max-w-3xl flex-1 px-4 py-24">
        ...
        <div className="prose prose-sm max-w-none space-y-4 text-muted-foreground">
          <p>By using FBupload Pro, you agree to these terms. This platform is a neutral SaaS tool for content distribution automation and is not affiliated with Meta.</p>
          ...
          <p>FBupload Pro provides automation tools to connect Facebook pages, download reels from source platforms, and publish on a schedule. Tokens are charged only for successfully published reels.</p>
          <h2 className="text-lg font-semibold text-foreground">Limitation of Liability</h2>
          <p>FBupload Pro acts as a technology conduit. We are not liable for account restrictions, content takedowns, or losses resulting from platform policy changes or user actions.</p>
