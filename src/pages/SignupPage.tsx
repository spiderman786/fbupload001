    ...
    <AuthLayout>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Your team workspace — signup creates you as <span className="font-medium text-foreground">Owner</span>. Invite Admins from Settings → Team.</p>
        </div>
